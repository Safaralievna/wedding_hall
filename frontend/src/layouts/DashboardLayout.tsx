...
export function DashboardLayout() {
  ...
  return (
    <div className="gradient-mesh flex min-h-screen">
      ...
      <aside
        className={`fixed inset-y-0 left-0 z-50 flex w-64 flex-col border-r border-white/5 bg-surface-900/95 backdrop-blur-xl transition-transform lg:static lg:translate-x-0 ${
      ...
      >
        ...
        <div className="border-t border-white/5 p-4">
          ...
          <button
            ...
            className="flex w-full items-center gap-2 rounded-xl px-3 py-2 text-sm text-slate-400 hover:bg-red-500/10 hover:text-red-300"
          >
      ...
      <div className="flex flex-1 flex-col">
        <header className="flex h-16 items-center gap-4 border-b border-white/5 px-4 lg:px-8">
          <button
            type="button"
          ...
          <Link to="/venues" className="text-sm text-slate-400 hover:text-white">
            Saytga qaytish →
          </Link>
        </header>
